...
namespace shoryutrain.Managers
{
    public class InputManager
    {
        ...
        private void InitializeDirectInputController()
        {
            ...
            {
                MessageBox.Show("No DirectInput controller detected.");
            }
        ...
        private void InitializeXInputController()
        {
            ...
            {
                MessageBox.Show("No XInput controller has been deteced. \n Try using DirectInput if you have an older controller.");
            }
